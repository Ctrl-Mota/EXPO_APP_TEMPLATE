...
import { coinReducer, DispatchContext, initialState, StateContext, StoreContext } from '../util/context/reducer';
...
const Start = ({ navigation }) => {
  ...
  return (
      <View style={styles.container}>
        <CText style={{ fontSize: fontSize.medium, color: colors.text }}>How many coins do you want to put in your digital wallet?</CText>
